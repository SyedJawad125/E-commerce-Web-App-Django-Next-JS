...
const AddProduct = () => {
  ...
  return (
    ...
    <h2 className="mt-4 text-2xl font-bold">Add Product Here:</h2>
    <form className="mt-3" onSubmit={handleSubmit}>
      <div className="mb-4">
        ...
        <input
          type="text"
          id="name"
          className="mt-1 block w-2/4 px-3 py-1 bg-white border border-gray-300 rounded-lg shadow-sm 
      ...
      <div className="mb-4">
        ...
        <input
          type="file"
          id="image"
          className="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-1 file:px-3 file:rounded-lg 
